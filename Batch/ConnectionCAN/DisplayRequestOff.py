...
def main():
  ...
  # v1 style
  #entry  = {'msgType': 'lscan', 'signalName': 'FrtCmrBlckdIO', 'value': '0'}
...
#IndTmpStngStRL value=1 (Temperature State)
  ...
  entry  = {'Type': 'Signal', 'Mode': 'HS', 'Name': 'LFSCDS_DispReq', 'Value': '0'}
  payload_Tx.append(entry)
  #entry  = {'Type': 'Signal', 'Mode': 'HS', 'Name': 'LFStStsDispActv', 'Value': '0'}
  #payload_Tx.append(entry)
