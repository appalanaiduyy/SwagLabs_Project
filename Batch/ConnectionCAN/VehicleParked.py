...
def main():
  ...
  if 'model:gminfo37' in val:
    ...
    entry = {'Type': 'Raw', 'Mode': 'RAW', 'Id': '527', 'Value': '0000000800000000'}
    payload_Tx.append(entry)
    #entry = {'Type': 'Raw', 'Mode': 'RAW', 'Id': '229', 'Value': '0000000000000000'}
    #payload_Tx.append(entry)
  elif 'model:gminfo38' in val:
    #place MY23 signals/msgs
    entry  = {'Type': 'Signal', 'Mode': 'HS', 'Name': 'VMMP_VehMtnMvmtStatAuth', 'Value': '0'}
    payload_Tx.append(entry)
